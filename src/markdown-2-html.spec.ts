...
describe("Markdown2Html", () => {
  describe("Traversing", () => {
    it("1- Should convert image links to img tag", () => {
      ...
      const expected =
        '<p><img class="markdown-img-link" src="https://steemitimages.com/0x0/https://img.esteem.ws/bbq3ob1idy.png" /></p>';
    ...
    it("7- Should handle d.tube videos", () => {
      ...
      const expected =
        '<p><a title="This link will take you away from steemit.com" class="markdown-video-link markdown-video-link-dtube" data-embed-src="https://emb.d.tube/#!/scottcbusiness/g04n2bbp"><img class="no-replace video-thumbnail" src="https://steemitimages.com/0x0/https://images.ecency.com/640x0/https://ipfs.io/ipfs/QmPhb9HA1gASFiNAUPFqMdSidTAj17L5SSoV3zbXUx8M7t" /><span class="markdown-video-play"></span></a></p>';
    ...
    it("7.1- Should handle raw d.tube videos without thumbnail", () => {
      ...
      const expected =
        '<p><a class="markdown-video-link markdown-video-link-dtube" data-embed-src="https://emb.d.tube/#!/techcoderx/QmVdEYicJwiTxSk2U9ER1Yc8Rumb1Nek4KynqAYGyQs7ga"><span class="markdown-video-play"></span></a></p>';
    ...
    it("26- Should handle speak videos", () => {
      ...
      const expected =
        '<p><a class="markdown-video-link markdown-video-link-speak" data-embed-src="https://3speak.online/embed?v=wehmoen/xrhjxocx"><img class="no-replace video-thumbnail" src="https://steemitimages.com/0x0/https://img.3speakcontent.online/xrhjxocx/post.png?v2" /><span class="markdown-video-play"></span></a></p>';
    ...
    it("27- Should handle speak videos with different tld", () => {
      ...
      const expected =
        '<p><a class="markdown-video-link markdown-video-link-speak" data-embed-src="https://3speak.co/embed?v=theycallmedan/blnmdkjt"><img class="no-replace video-thumbnail" src="https://steemitimages.com/0x0/https://img.3speakcontent.co/blnmdkjt/post.png" /><span class="markdown-video-play"></span></a> <a class="markdown-external-link" data-href="https://3speak.co/watch?v=theycallmedan/blnmdkjt">Watch on 3Speak</a></p>';
    ...
    it("34- Should handle ipfs links", () => {
      ...
      const expected =
        '<p>this is link <a data-href="https://ipfs.io/ipfs/bafybeihbqfrcrbr6jkf77rdve3nbxjzkfgmeneaw2x5s43qdgpe26cha6q" class="markdown-img-link"><img src="https://steemitimages.com/0x0/https://ipfs.io/ipfs/bafybeihbqfrcrbr6jkf77rdve3nbxjzkfgmeneaw2x5s43qdgpe26cha6q" /></a></p>';
    ...
    it("39- Should form profile page sections with copied links", () => {
      ...
      const expected =
        '<p><a href="https://ecency.com/@good-karma/wallet" class="markdown-profile-link">click here</a></p>';
    ...
    it("46 - Should handle copied md links", () => {
      ...
      const expected =
        '<p><a href="https://ecency.com/@praetoria-cartel/wallet" class="markdown-profile-link">click here</a> direct link <a href="https://ecency.com/@praetoria-cartel/posts" class="markdown-profile-link">@praetoria-cartel/posts</a></p>';
    ...
    it("47 - Should handle internal links", () => {
      ...
      const expected =
        '<p><span>for history refer to this fine post <a class="markdown-post-link" data-author="offgridlife" data-tag="post" data-permlink="proofofbrain-golden-rule-do-to-others-what-you-want-them-to-do-to-you">@offgridlife/proofofbrain-golden-rule-do-to-others-what-you-want-them-to-do-to-you</a> and while you are in the community</span></p>';
    ...
    it("48 - Should handle Bitchute links", () => {
      ...
      const expected =
        '<p><a class="markdown-video-link" data-embed-src="https://www.bitchute.com/embed/DJJvTZQxMaNK/"><span class="markdown-video-play"></span></a></p>';
      expect(markdown2Html(input)).toBe(expected);
    });
    ...
    it("49 - Should handle Bitchute iframes", () => {
      ...
      const expected =
        '<iframe frameborder="0" src="https://www.bitchute.com/embed/DJJvTZQxMaNK/"></iframe>';
      expect(markdown2Html(input)).toBe(expected);
    });
    ...
    it("50 - Should handle user slash link", () => {
      ...
      const expected =
        '<p><a class="markdown-author-link" data-author="hivesql"><img src="https://steemitimages.com/0x0/https://i.imgur.com/EPN8RW6.png" /></a></p>';
      expect(markdown2Html(input)).toBe(expected);
    });
    ...
    it("51 - Should handle posts without tags internal link", () => {
      ...
      const expected =
        '<p><a class="markdown-post-link" data-tag="post" data-author="demo" data-permlink="test">test post</a></p>';
      expect(markdown2Html(input)).toBe(expected);
    });
    ...
    it("52 - Should handle filtered tag link", () => {
      ...
      const expected =
        '<p><a class="markdown-tag-link" data-filter="trending" data-tag="books">/trending/books</a></p>';
      expect(markdown2Html(input)).toBe(expected);
    });
    ...
    it("54 - Should highlight code", () => {
      ...
      expect(markdown2Html(input)).toBe(
        SNAPSHOT_JSON.markdown_2_html_traversing_54_should_highlight_code
      );
    });
    ...
    it("55 - Should detect loom share", () => {
      ...
      const expected =
        '<p><a class="markdown-video-link markdown-video-link-loom"><iframe frameborder="0" allowfullscreen="true" src="https://www.loom.com/embed/5bbdeb480ba84e65b1b3de8c190e2003" sandbox="allow-scripts allow-same-origin allow-popups"></iframe></a></p>';
      expect(markdown2Html(input)).toBe(expected);
    });
    ...
    it("56 - Should detect loom embed", () => {
      ...
      const expected =
        '<iframe src="https://www.loom.com/embed/5bbdeb480ba84e65b1b3de8c190e2003" frameborder="0" webkitallowfullscreen="webkitallowfullscreen" mozallowfullscreen="mozallowfullscreen" allowfullscreen="allowfullscreen"></iframe>';
      expect(markdown2Html(input)).toBe(expected);
    });
    ...
    it("59 - Should handle Aureal iframe", () => {
      ...
      const expected =
        '<p>this is link <iframe src="https://aureal-embed.web.app/535939" frameborder="0" class="lazyloaded"></iframe></p>';
    ...
    it("60 - Should username with permlink", () => {
      ...
      const expected =
        '<p><span>this is link <a class="markdown-post-link" data-author="demo" data-tag="post" data-permlink="test">@demo/test</a> for internal</span></p>';
    ...
    it("62 - Should username with permlink new line", () => {
      ...
      const expected =
        '<p><span> <a class="markdown-post-link" data-author="demo" data-tag="post" data-permlink="test">@demo/test</a> for internal</span></p>';
    ...
    it("64 - Should username with section link", () => {
      ...
      const expected =
        '<p><span> <a class="markdown-profile-link" href="/@demo/wallet">@demo/wallet</a> for internal</span></p>';
    ...
    it("66 - Should handle internal links with params", () => {
      ...
      const expected =
        '<p>direct link <a class="markdown-post-link" data-tag="post" data-author="ecency" data-permlink="faq?history">@ecency/faq?history</a></p>';
    ...
    it("67 - Should handle section links with params", () => {
      ...
      const expected =
        '<p>direct link <a href="https://ecency.com/@ecency/posts?q=games" class="markdown-profile-link">@ecency/posts?q=games</a></p>';
    ...
    it("68 - Should handle section links", () => {
      ...
      const expected =
        '<p>this is link <a href="#WhatHive" class="markdown-internal-link">What is HIVE</a> and locatino ## 1 <a data-id="WhatHive"></a>What is HIVE?</p>';
  ...
  describe("Rumble support", () => {
    it("Rumble iframes", () => {
      let expected =
        '<iframe frameborder="0" src="https://rumble.com/embed/vhwsp4/?pub=4"></iframe>';
      let input = {
        author: "foo350x",
        permlink: "bar350x",
    ...
    it("Rumble embed URL", () => {
      const expected =
        '<p><a class="markdown-video-link" data-embed-src="https://www.rumble.com/embed/vhwsp4/?pub=4"><span class="markdown-video-play"></span></a></p>';
      let input = {
        author: "foo350y",
        permlink: "bar350y",
  ...
  describe("Brightreon support", () => {
    it("Brightreon iframes", () => {
      let expected =
        '<iframe src="https://www.brighteon.com/embed/5821540656001" frameborder="0" allowfullscreen="allowfullscreen"></iframe>';
      let input = {
        author: "foo351x",
        permlink: "bar351x",
        last_update: "2021-05-10T09:15:50",
    ...
    it("Brightreon embed URL", () => {
      const expected =
        '<p><a class="markdown-video-link" data-embed-src="https://www.brighteon.com/embed/5821540656001"><span class="markdown-video-play"></span></a></p>';
      let input = {
        author: "foo351y",
        permlink: "bar351y",
        last_update: "2021-05-10T09:16:50",
  ...
  describe("Brand new tube support", () => {
    it("Brand new tube iframes", () => {
      let expected =
        '<iframe src="https://brandnewtube.com/embed/BSqeH7nhg8I41rM" frameborder="0" allowfullscreen="allowfullscreen"></iframe>';
      let input = {
        author: "foo352x",
        permlink: "bar352x",
        last_update: "2021-05-10T09:15:50",
  ...
  describe("forApp = false", () => {
    it("1", () => {
      ...
      const expected =
        '<p><img class="markdown-img-link" src="https://steemitimages.com/0x0/https://img.esteem.ws/bbq3ob1idy.png" /> <a href="/esteem/@esteemapp/esteem-monthly-guest-curation-program-4" class="markdown-post-link">fooo</a> <a href="/esteem/@esteemapp/esteem-monthly-guest-curation-program-4" class="markdown-post-link">bar</a> <a href="http://external.com/loromoro" class="markdown-external-link" target="_blank" rel="noopener">baz</a><span> <a class="markdown-tag-link" href="/trending/lorem">#lorem</a> <a class="markdown-author-link" href="/@ipsum">@ipsum</a> </span><a href="https://steemit.com/~witnesses" class="markdown-external-link" target="_blank" rel="noopener">vote me</a></p>';
    ...
    it("4 - Should handle filtered tag internal link", () => {
      ...
      const expected =
        '<p><a href="/trending/books" class="markdown-tag-link">trending books</a></p>';
      expect(markdown2Html(input, false)).toBe(expected);
    });
  });
