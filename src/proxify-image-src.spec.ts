...
describe("getLatestUrl", () => {
  ...
  it("3- should get the latest url", () => {
    const input =
      "https://images.ecency.com/0x0/https://images.hive.io/0x0/https://i.imgur.com/muESb0B.png";
...
describe("Proxify image src", () => {
  ...
  it("4- replace already proxified", () => {
    ...
    const input =
      "https://images.hive.blog/60x70/http://hivebuzz.me/@hiveonboard/upvotes.png?202008050233";
    const expected =
      "https://images.ecency.com/60x70/http://hivebuzz.me/@hiveonboard/upvotes.png?202008050233";
