...
describe("catchPostImage", () => {
  ...
  it("6- Should extract entry image from markdown img tag", () => {
    const input = {
      ...
      permlink: "bar6",
      json_metadata: "{}",
      body: "<center>![ezrni9y9pw.jpg](https://img.esteem.ws/ezrni9y9pw.jpg)</center><hr>",
      last_update: "2019-05-10T09:15:21",
    };
    ...
    const input = {
      json_metadata: {
        image: [
          ...
          "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.adafruit.com%2Fblog%2Fwp-content%2Fuploads%2F2014%2F04%2Fgeordi-la-forge-600x458.jpg&amp;f=1&amp;nofb=1",
        ],
      },
    };
